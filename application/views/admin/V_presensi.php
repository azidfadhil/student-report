...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <a class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm" id="btnTutorialTambahPresensi" href="/sop_laporan_presensi_excel.pdf">
      ...
      <table class="table table-bordered table-sm table-hover" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= $p->jml_siswa ?></td>
            <td class="text-center">
              <a class="btn btn-success btn-sm" href="show-presensi.php?id=" target="_blank" title="Lihat Presensi"><i class="fas fa-file-excel"></i></a>
              <a class="btn btn-secondary btn-sm" href="upload/presensi/" title="Download Presensi"><i class="fas fa-file-download"></i></a>
              <a class="btn btn-warning btn-sm" href="edit-presensi.php?id=" title="Edit Presensi"><i class="fas fa-pencil-alt"></i></a> 
